...
//        userTrajectoryDTOList = sparkContext.parallelize(userTrajectoryDTOList)
...
//                }).collect();
    ...
    @CrossOrigin
    public List<TrajectorPathVO> pathByTimeScopeWithoutRedis(@RequestParam("start_time") Long startTime,
                                                 @RequestParam("end_time") Long endTime,
                                                 @RequestParam("top_latitude") Double topLatitude,
                                                 @RequestParam("bottom_latitude") Double bottomLatitude,
                                                 @RequestParam("left_longitude") Double leftLongitude,
